...
#### Task PH09-COMPLETE-001

**Title:** Complete Employees / HR Foundation Phase
**Status:** `DONE`
**Priority:** LOW
**Scope:**

- استئناف العمل المتوقف داخل PH-09 فقط
- إضافة Employee model و migration
- إضافة Employees CRUD API مع الصلاحيات وعزل الشركة
- إضافة صفحة `/dashboard/employees` وربطها بالـ Sidebar
- إضافة اختبارات Employees foundation
