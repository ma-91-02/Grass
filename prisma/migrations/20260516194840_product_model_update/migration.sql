...
-- CreateEnum
CREATE TYPE "CustomerTypeEnum" AS ENUM ('INDIVIDUAL', 'MARKET', 'WHOLESALE', 'AGENT', 'ONLINE');
...
CREATE TABLE "Customer" (
    ...
    "whatsapp" TEXT,
    "address" TEXT,
    "customerType" "CustomerTypeEnum" NOT NULL DEFAULT 'INDIVIDUAL',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "Product" (
    ...
    "barcode" TEXT,
    "categoryId" TEXT,
    "packaging" TEXT NOT NULL DEFAULT 'قطعة',
    "piecesPerCarton" INTEGER NOT NULL DEFAULT 0,
    "unit" TEXT NOT NULL DEFAULT 'قطعة',
    "purchasePrice" DECIMAL(65,30) NOT NULL DEFAULT 0,
    "purchaseCurrency" "Currency" NOT NULL DEFAULT 'IQD',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ExchangeRate" (
    "id" TEXT NOT NULL,
    "usdToIqd" DECIMAL(65,30) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductPackaging_name_key" ON "ProductPackaging"("name");
...
-- CreateIndex
CREATE UNIQUE INDEX "ProductPrice_productId_customerType_key" ON "ProductPrice"("productId", "customerType");
